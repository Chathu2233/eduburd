...
<header>
    ...
    <nav>
        <ul>
            ...
            <li><a href="<?php echo ROOT; ?>/views/student/findatutor.php">Find A Tutor</a></li>
    ...
    <div class="auth-buttons">
        ...
        <?php if (isset($_SESSION['user_id']) && $_SESSION['user_role'] === 'student'): ?>
            <!-- Profile Picture or Icon and Dropdown for logged-in student -->
        ...
        <?php endif; ?>
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="<?php echo ROOT; ?>/views/student/myprofile.php">My Profile</a>
...
<script>
    ...
    function fetchNotifications() {
        fetch('<?php echo ROOT; ?>/views/student/student_fetchnotifications.php')
