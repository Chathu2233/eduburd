...
<head>
    ...
    <link rel="stylesheet" href="<?php echo ROOT; ?>/assets/css/student/resourcelibrary.css">
</head>
<body>
    ...
    <div class="content-wrapper">
        ...
        <div class="resource-container">
            ...
            <div class="add-resource-button">
             <a href="<?php echo ROOT; ?>/views/student/resourceadd.php">
                ...
                <?php else: ?>
                    <?php foreach ($resources as $resource): ?>
                        <div class="resource" data-type="<?php echo htmlspecialchars($resource['type']); ?>">
                            <img src="<?php echo ROOT; ?>/assets/images/<?php echo htmlspecialchars($resource['type']); ?>.png" alt="Resource Icon">
