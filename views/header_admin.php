...
<header>
    ...
    <nav>
        <ul>
            ...
            <li><a href="<?php echo ROOT; ?>/views/admin/admindashboard.php">My Dashboard</a></li>
        </ul>
    </nav>
    <div class="auth-buttons">
        ...
        <div class="notifications-container">
            ...
            <div id="notifications-popup" class="notifications-popup">
                ...
                <button id="clear-notifications-btn" class="clear-notifications-btn">Clear Notifications</button>
            </div>
        </div>

        <?php if (isset($_SESSION['user_id']) && $_SESSION['user_role'] === 'admin'): ?>
            <!-- Profile Picture or Icon and Dropdown for logged-in admin -->
            <div class="profile-container">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="<?php echo ROOT; ?>/views/admin/myprofile.php">My Profile</a>
...
<script>
    ...
    function fetchNotifications() {
        console.log('fetchNotifications is defined and called'); // Debugging
        fetch('<?php echo ROOT; ?>/views/admin/admin_fetchnotifications.php')
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        clearNotificationsBtn.addEventListener('click', function () {
            ...
            // Add a "No new notifications" message
            const noNotifications = document.createElement('li');
            noNotifications.textContent = 'No new notifications.';
            notificationsList.appendChild(noNotifications);
