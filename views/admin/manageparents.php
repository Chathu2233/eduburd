...
<div id="parentForm" class="form-container" style="display: none;">
    ...
    <form action="" method="POST" onsubmit="return validateParentForm();">
        <input type="hidden" id="parentId" name="parent_id">

        <!-- First Name -->
        <div class="form-group">
            <label for="parentFirstName">First Name</label>
            <input type="text" id="parentFirstName" name="parentFirstName" placeholder="Enter First Name" required>
        </div>

        <!-- Last Name -->
        <div class="form-group">
            <label for="parentLastName">Last Name</label>
            <input type="text" id="parentLastName" name="parentLastName" placeholder="Enter Last Name" required>
        </div>
...
<script>
    ...
    function toggleForm() {
        ...
        // Scroll to the form
        document.getElementById('parentForm').scrollIntoView({ behavior: 'smooth' });
    }
