                        ...
                        <?php foreach ($tutorPayments as $payment): ?>
                            <?php if ($payment['pending_amount'] > 0): ?>
                                <tr>
                                    ...
                                    <td>LKR <?= number_format($payment['total_received'], 2) ?></td>
                                    <td>LKR <?= number_format($payment['total_owed'], 2) ?></td>
                                    <td>LKR <?= number_format($payment['total_released'], 2) ?></td>
                                    <td>LKR <?= number_format($payment['pending_amount'], 2) ?></td>
                                    <td>
