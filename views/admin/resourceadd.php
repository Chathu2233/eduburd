...
if (isset($_POST['add_resource'])) {
    ...
    if ($file['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($file['tmp_name'], $file_path)) {
            ...
            $sql = "INSERT INTO resource_library (title, description, file_path, created_at) 
...
if (isset($_POST['delete_id'])) {
    ...
    $sql = "SELECT file_path FROM resource_library WHERE resource_id = :id";
    $stmt = $pdo->prepare($sql);
    $stmt->execute([':id' => $id]);
    ...
    if ($resource) {
        ...
        $sql = "DELETE FROM resource_library WHERE resource_id = :id";
        $stmt = $pdo->prepare($sql);
...
// Fetch all resources
$sql = "SELECT * FROM resource_library ORDER BY created_at DESC";
$stmt = $pdo->prepare($sql);
$stmt->execute();
...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/admin/resourceadd.css">
</head>
<body>
    <!-- Header Section -->
    <header class="navbar">
    ...
    <div class="container">
        ...
        <div class="back-button">
            <a href="resourcelibrary.php" class="styled-back-button">← Back to Resource Library</a>
        </div>
